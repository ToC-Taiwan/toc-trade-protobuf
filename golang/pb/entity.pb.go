...
var file_forwarder_entity_proto_goTypes = []any{
...
func file_forwarder_entity_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_forwarder_entity_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_forwarder_entity_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_forwarder_entity_proto_msgTypes[2].Exporter = func(v any, i int) any {
